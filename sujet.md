...
4)
 ...
 - In your opinion, does this mean that WebAssembly implementations should not be tested ? Tout doit être testé. Le code WebAssembly est exécuté, utilisé sur le machines des utilsateurs, les bugs provienent des utilisateurs. Et peut être meme des développeurs de WebAssembly. 
